                    ...
                    <div class="p-3">
                        <form class="form-horizontal mt-3" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input class="form-control @if($errors->has('name')) is-invalid @endif" type="text" id="name" name="name" required="" value="{{ old('name') }}" placeholder="Name">
                                    @if($errors->has('name'))
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input class="form-control @if($errors->has('username')) is-invalid @endif" type="text" id="username" name="username" value="{{ old('username') }}" required="" placeholder="Username">
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input class="form-control @if($errors->has('password')) is-invalid @endif" type="password" id="password" name="password" value="{{ old('password') }}" required="" placeholder="Password">
                            ...
                            <div class="form-group mb-3 row">
                                <div class="col-12">
                                    <input class="form-control @if($errors->has('password_confirmation')) is-invalid @endif" type="password" id="password_confirmation" name="password_confirmation" value="{{ old('password_confirmation') }}" required="" placeholder="Confirm Password">
